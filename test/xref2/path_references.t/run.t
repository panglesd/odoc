  ...
  Warning: Failed to resolve reference ./dup is of kind page path but expected page
  ...
  Warning: Failed to resolve reference ./bar is of kind page path but expected page
  ...
  Warning: Failed to resolve reference ./subdir/dup is of kind page path but expected page
  ...
  Warning: Failed to resolve reference ./subdir/bar is of kind page path but expected page
